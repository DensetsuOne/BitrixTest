...
namespace Sprint\Migration;
    ...
    class M20240320174551_add_IB_products extends Version
{
    protected $description = "Создание ИБ продукция";
  ...
  array (
    ...
    array (
      ...
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'aca6a3a62616117032f19a28e1cc58d0',
    ),
    1 => 
    array (
      'VALUE' => 'кг',
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'bc2aa6a153e05242a6d7be36d3ccd010',
    ),
    2 => 
    array (
      'VALUE' => 'л',
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'adf732e9279b4967abed99a358609dc1',
    ),
    3 => 
    array (
      'VALUE' => 'уп',
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'ee38cfce001c2298c20eda9a767ae89a',
    ),
    4 => 
    array (
      'VALUE' => 'шт',
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => '7d0566d10ff278401fb3a85d80d3ae27',
    ),
  ),
  'FEATURES' => 
  array (
  ...
  'current_view' => 'default',
    ...
    {
        $helper = $this->getHelperManager();
        $iblockId = $helper->Iblock()->getIblockIdIfExists('category_products', 'products');
